...
async function handleTicketRating(
	...
	try {
		// Update the ticket metadata with the rating
		await api.updateTicketRating(interaction.client.user.id, threadId, rating);

		// Update the message to show the rating has been recorded
